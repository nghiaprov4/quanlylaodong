...
public class SuaNhanVien extends JFrame implements ActionListener{
	...
	public SuaNhanVien() throws SQLException {
		...
		pnNorth = new JPanel();
		pnNorth.add(lblTitle = new JLabel("SỬA NHÂN VIÊN"));
		...
		btnSua.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				int ret=JOptionPane.showConfirmDialog(null,
						"Bạn muốn sửa nhân viên này?", "Sửa",
				...
				int rowClicked = tbNhanVien.getSelectedRow();
		    	    ...
		    	    String maPB = maPBtemp[0].trim();
					NhanVien nhanVien = new NhanVien(maNV, tenNV, ngaySinh, gioiTinh, diaChi, new PhongBan(maPB));
					try {
						if(list.editElement(maNV, nhanVien) == true) {
...
//						tbNhanVienModel.addRow(new Object[]{ nhanVien.getMaNV(), nhanVien.getTenNV(), nhanVien.getNgaySinh(), nhanVien.getGioiTinh(), nhanVien.getDiaChi(), nhanVien.getPhongBan().getMaPB() });
						...
						tbNhanVien.setRowSelectionInterval(rowClicked, rowClicked);
					}else {
						JOptionPane.showMessageDialog(null, "Không được sửa mã Nhân Viên");
						txtmaNV.selectAll();
	...
	private void XoaHetDuLieuTrenTableModel() {
		// TODO Auto-generated method stub
		DefaultTableModel dm = (DefaultTableModel) tbNhanVien.getModel();
...
//		}
		...
		if(cbbModelPhongBan.getSelectedItem().toString() == "...") {
