...
public class SuaPhanCong extends JFrame implements ActionListener {
	...
	public SuaPhanCong() throws SQLException {
		...
		pnNorth = new JPanel();
		pnNorth.add(lblTitle = new JLabel("SỬA PHÂN CÔNG"));
			...
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					if(list.editElement(maCT, maNV, pc) == true){
						...
						JOptionPane.showMessageDialog(null, "Không tồn tại nhân viên hoặc công trình");
					}
	...
	public boolean validData() {
		...
		if(soluongngaycong.length() > 0){
			try {
				...
				JOptionPane.showMessageDialog(null, "Số lượng ngày công là ký tự số.");
			}
		}
