...
public class TimKiemCongTrinh extends JFrame implements ActionListener  {
	/**
	 * 
	 */
	...
	public TimKiemCongTrinh() throws SQLException {
		...
		pnNorth = new JPanel();
		pnNorth.add(lblTitle = new JLabel("TÌM KIẾM CÔNG TRÌNH"));
		...
		pnTask.add(btnXemThongTin = new JButton("Xem thông tin nhân viên làm việc"));
		...
		btnXemThongTin.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				try {
					new infoCongTrinh(Integer.parseInt(txtmacongtrinh.getText())).setVisible(true);
					setVisible(false);
