...
public class XoaCongTrinh extends JFrame implements ActionListener  {
	/**
	 * 
	 */
	...
	public XoaCongTrinh() throws SQLException {
		...
		pnNorth = new JPanel();
		pnNorth.add(lblTitle = new JLabel("XOÁ CÔNG TRÌNH"));
		...
		btnXoa.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				int ret=JOptionPane.showConfirmDialog(null,
						"Bạn muốn xoá công trình này?", "Xoá",
				...
				try {
					...
					// TODO Auto-generated catch block
					JOptionPane.showMessageDialog(null, "Công trình còn tồn tại nhân viên");
				}
